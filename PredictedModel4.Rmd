...
Cross falidation can be performed using three separate methods.  
...
###Error Rate
The error rates for each model are shown above based on the validation set.  When looking at the current models, we see an accuracy rate above 99%.  We utilize the 3 models to reduce the error rate.  The calculation has not yet been completed to see the final rate.
