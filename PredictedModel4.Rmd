...
###Error Rate
The error rates for each model are shown above based on the validation set.  When looking at the current models, we see an accuracy rate above 99%.  We utilize the 3 models to reduce the error rate.  The out of sample 
